...
APPLICATION_PATH := $(DIGISPARK_AVR_PATH)
PLATFORM_VERSION := $(DIGISPARK_AVR_RELEASE) for Arduino 1.6.5

HARDWARE_PATH     = $(APPLICATION_PATH)/hardware/avr/$(DIGISPARK_AVR_RELEASE)
