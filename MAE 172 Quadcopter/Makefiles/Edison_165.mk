...
TOOL_CHAIN_PATH   = $(APPLICATION_PATH)/tools/core2-32-poky-linux/$(INTEL_EDISON_RELEASE)/i686/pokysdk/usr/bin/i586-poky-linux
OTHER_TOOLS_PATH  = $(APPLICATION_PATH)/tools/core2-32-poky-linux/$(INTEL_EDISON_RELEASE)/i686/core2-32-poky-linux
...
CPPFLAGS    += --sysroot=$(OTHER_TOOLS_PATH)
...
LDFLAGS     += --sysroot=$(OTHER_TOOLS_PATH)
